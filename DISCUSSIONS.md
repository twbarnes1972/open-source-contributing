...
|--------|------|------|------|-------|--------------|-------------|
| [#13428](https://github.com/sqlalchemy/sqlalchemy/discussions/13428) | sqlalchemy/sqlalchemy | Discussion | [ISSUE-0001](./tasks/open/ISSUE-0001.md) | waiting-on-maintainer | 2026-07-12 | [Reply v3 posted 2026-07-12](https://github.com/sqlalchemy/sqlalchemy/discussions/13428#discussioncomment-17615486): corrected our cache=shared claim (URL-spelling/pool artifact), validated zzzeek's recipe + memdb, offered branch via Gerrit or as material for his in-flight docs rewrite. Watch for: rewrite landing, Gerrit invitation, or classification-fix interest |
