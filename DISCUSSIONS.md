...
| [#36884](https://github.com/anthropics/claude-code/issues/36884) | anthropics/claude-code | Issue | [ISSUE-0002](./tasks/open/ISSUE-0002.md) | needs-our-reply | 2026-07-12 | Stale-closed 2026-07-07 ("not planned", never triaged) with our [root-cause comment](https://github.com/anthropics/claude-code/issues/36884#issuecomment-4474702923) on it — decide reopen vs consolidate onto #57132 (operator + freshness check first) |
| [#57132](https://github.com/anthropics/claude-code/issues/57132) | anthropics/claude-code | Issue | [ISSUE-0002](./tasks/open/ISSUE-0002.md) | needs-our-reply | 2026-07-12 | Natural primary thread now — `hwaterer` (2026-06-10) points readers to our #36884 analysis; candidate target for consolidated root-cause post |
